...
namespace BeCoreApp.Areas.Admin.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public IActionResult Register(string id)
        {
            ...
            {
                id = "5a2ee9fb-fe08-455a-cb78-08d92999ad5d";
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel registerVm)
        {
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(registerVm.Email, "eaglecoin.info: Verify Email", content);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            try
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "eaglecoin.info: Forgot password", content);
